<?php $conn = new PDO('mysql:host=localhost; dbname=gantt','root', ''); ?>
 ...
 <style>
body > div > div > div > div > div > div:nth-child(2) > div.row.top-buffer > div > div > div > div > div.mtablescrolls > div > div > div.gantt-side > div.gantt-side-content > div:nth-child(1) > div > div.gantt-tree-body > div > div.angular-ui-tree > ol > li > div > div > div{color:#fff;}
 </style>
        ...
        return {
            getSampleData: function() {
				...
				?> 
                        ...
                        {name: "<?php echo $project_name; ?>", height: '3em', color: '#00006B',
						children: [
						<?php 
                        ...
                        {name: "<?php echo $checklist; ?>", tooltips: true, tasks: [
                            {name: "<?php echo $checklist; ?> - <?php echo $progress; ?>%", color: '#F1C232', from:  new Date("<?php echo $clstart_date;?>"), to:  new Date("<?php echo $clend_date; ?>"),
